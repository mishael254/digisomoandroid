...
const Logo = require('../assets/imgs/digisomo2-transformed.png');
const ProfileBackground = require('../assets/imgs/bg5.png');
const RegisterBackground = require('../assets/imgs/register-bg.png');
const Pro = require('../assets/imgs/bg.png');
const NowLogo = require('../assets/imgs/digisomo2-transformed.png');
...
const InvisionLogo = require('../assets/imgs/cbcc.png');
